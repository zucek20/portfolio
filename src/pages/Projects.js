      ...
      {isEng ? (
        ...
        <div className="wrap">
          ...
          <article className="company">
            <div className="text">
              <h3>Commercial site for a architecture company</h3>
              <p>
              The project contains a commercial, responsive website advertising a architecture company. Its purpose is to encourage visitors to contact the company.
                <br />
                <br />
